        ...
        <div className="min-h-screen flex items-center justify-center bg-paper px-4">
            <div className="w-full max-w-sm">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-ink-secondary">Access your fleet dashboard</p>
                </div>
                ...
                <p className="text-center text-sm text-ink-secondary mt-4">
                    No account?{' '}
                    <a href="/auth/register" className="text-ink font-medium underline underline-offset-2 hover:text-brand">
                        Create one
                    </a>
                </p>
            </div>
